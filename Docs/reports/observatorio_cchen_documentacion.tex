...
\begin{titlepage}
  ...
  \begin{tabular}{ll}
    ...
    \faDatabase\quad \textbf{Tablas Supabase:} & 34 tablas operativas · RLS habilitado \\[4pt]
...
Data lake local (CSV) + data warehouse curado en Supabase (34 tablas, RLS habilitado, pgvector activado). Migración completa con 8 scripts idempotentes especializados (\file{Database/migrate\_*.py}). Paginación automática de 1.000 filas/request para tablas grandes.
...
\begin{itemize}
  ...
  \item Row-Level Security (RLS) habilitado en las 34 tablas operativas
...
\section{Tablas operativas (34 tablas)}
...
\begin{longtable}{L{4.2cm} R{1.8cm} L{3cm} L{3.5cm}}
  ...
  \texttt{dian\_publications} & 133 & \texttt{dian\_id} & DIAN CCHEN (Excel) \\
  \midrule
