# Pendientes de información — Gobernanza operativa DGIn

## Objetivo

Registrar la información mínima faltante para consolidar continuidad operativa del piloto DGIn y cerrar brechas de gobernanza antes de semana 3.
...
1. Nombre completo del responsable DGIn titular.
2. Nombre completo del responsable DGIn respaldo.
3. Correo institucional del titular.
4. Correo institucional del respaldo.
5. Regla de reemplazo operativo (quién decide si ambos no están disponibles).
6. Canal oficial de coordinación semanal (correo, Teams u otro).

## Uso de esta información

- Completar actas semanales con responsables nominales.
- Actualizar tracker KPI con responsables reales.
- Asegurar continuidad de decisiones entre sesiones.
- Escalar alertas y bloqueos sin ambiguedad.

## Responsable de proveer datos

- Dueño esperado: Jefatura DGIn.
- Apoyo de consolidación: Analista Observatorio.
...
1. Confirmar titular DGIn (nombre + correo institucional).
2. Confirmar respaldo DGIn (nombre + correo institucional).
3. Definir regla de reemplazo si ambos no están disponibles.
4. Definir canal oficial semanal (correo / Teams / otro).
5. Actualizar acta de semana 2 y tracker KPI con responsables nominales.
...
Asunto: Confirmación responsables DGIn para continuidad operativa del Observatorio

Hola,

Para cerrar la gobernanza operativa antes de semana 3, necesitamos confirmar hoy:

1) Responsable DGIn titular (nombre y correo)
2) Responsable DGIn respaldo (nombre y correo)
3) Regla de reemplazo si ambos no están disponibles
4) Canal oficial semanal de coordinación

Con esto actualizamos acta y tracker KPI, y dejamos continuidad formal del flujo semanal.
