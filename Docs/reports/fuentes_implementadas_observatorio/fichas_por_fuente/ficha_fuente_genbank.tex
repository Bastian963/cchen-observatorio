...
\hypersetup{colorlinks=true, linkcolor=cchenpurple, urlcolor=cchenpurple,
  pdftitle={Ficha de fuente de información - GenBank},
  pdfauthor={CCHEN 360}}
\urlstyle{same}
\pagestyle{fancy}
\fancyhf{}
...
\begin{center}
{\fontsize{16}{17.5}\selectfont\bfseries\color{cchenpurple}GenBank}\\[-1pt]
{\fontsize{9.1}{10.4}\selectfont\color{textgray}Ficha de fuente de información para datos relacionados con CCHEN}\\[-1pt]
{\fontsize{7.8}{9}\selectfont\color{mutedgray}Código: \texttt{genbank} \quad | \quad Categoría: Life Sciences}
\end{center}
\vspace{0.01cm}
...
Base de secuencias genéticas de NCBI. En esta etapa queda como referencia derivada, no como extracción directa.

\sectiontitle{2. Qué datos se descargaron}
\begin{calloutbox}{Tipología de datos}
Secuencias genéticas relacionadas por flujos biomédicos derivados
\end{calloutbox}
\textbf{Datos descargados para CCHEN.} No hay extractor directo GenBank; la evidencia viene de PubMed/radiofarmacia como aproximacion temática.
...
\begin{itemize}
  ...
  \item \textbf{Potencial:} Aporta secuencias genéticas para completar vistas del observatorio.
\end{itemize}
...
\vspace{0.02cm}
{\scriptsize\color{mutedgray}Sitio: https://www.ncbi.nlm.nih.gov/genbank/ \quad | \quad Interfaz de datos: sin interfaz registrada}
