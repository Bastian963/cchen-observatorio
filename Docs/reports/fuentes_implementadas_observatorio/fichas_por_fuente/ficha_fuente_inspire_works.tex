...
\hypersetup{colorlinks=true, linkcolor=cchenpurple, urlcolor=cchenpurple,
  pdftitle={Ficha de fuente de información - INSPIRE},
  pdfauthor={CCHEN 360}}
\urlstyle{same}
\pagestyle{fancy}
\fancyhf{}
...
\begin{center}
{\fontsize{16}{17.5}\selectfont\bfseries\color{cchenpurple}INSPIRE}\\[-1pt]
{\fontsize{9.1}{10.4}\selectfont\color{textgray}Ficha de fuente de información para datos relacionados con CCHEN}\\[-1pt]
{\fontsize{7.8}{9}\selectfont\color{mutedgray}Código: \texttt{inspire} \quad | \quad Categoría: Científica}
\end{center}
\vspace{0.01cm}
...
Base especializada en física de altas energías y áreas afines. Es útil para producción CCHEN en física, plasma y temas nucleares.

\sectiontitle{2. Qué datos se descargaron}
\begin{calloutbox}{Tipología de datos}
Publicaciones/preprints de fisica e informacion académica especializada
\end{calloutbox}
\textbf{Datos descargados para CCHEN.} CSV de trabajos académicos de fisica filtrados por señal CCHEN.
...
\begin{itemize}
\item \path{Data/Publications/cchen_inspire_works.csv}
\item \path{Data/Publications/inspire_state.json}
\end{itemize}

\sectiontitle{5. Estadística de descarga}
Registros obtenidos/evidencia: 21. Archivos locales generados o registrados: 2. Calidad registrada: 1.0. Última actualización: 2026-05-11. Estado de corrida: seeded\_from\_resultados.

\end{minipage}\hfill
\begin{minipage}[t]{0.48\textwidth}\raggedright
\sectiontitle{6. Para qué sirve en el observatorio}
\begin{itemize}
  \item \textbf{Uso principal:} Cubrir fisica, plasma, altas energias y areas afines donde CCHEN tiene produccion.
  \item \textbf{Potencial:} Cubrir fisica, plasma, altas energias y areas afines donde CCHEN tiene produccion.
\end{itemize}
...
\vspace{0.02cm}
{\scriptsize\color{mutedgray}Sitio: https://inspirehep.net \quad | \quad Interfaz de datos: https://github.com/inspirehep/rest-api-doc}
