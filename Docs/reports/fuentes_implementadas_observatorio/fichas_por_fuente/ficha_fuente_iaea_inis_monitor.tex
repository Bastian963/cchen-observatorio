...
\hypersetup{colorlinks=true, linkcolor=cchenpurple, urlcolor=cchenpurple,
  pdftitle={Ficha de fuente de información - IAEA (INIS)},
  pdfauthor={CCHEN 360}}
\urlstyle{same}
\pagestyle{fancy}
\fancyhf{}
...
\begin{center}
{\fontsize{16}{17.5}\selectfont\bfseries\color{cchenpurple}IAEA (INIS)}\\[-1pt]
{\fontsize{9.1}{10.4}\selectfont\color{textgray}Ficha de fuente de información para datos relacionados con CCHEN}\\[-1pt]
{\fontsize{7.8}{9}\selectfont\color{mutedgray}Código: \texttt{iaea\_inis} \quad | \quad Categoría: Nuclear}
\end{center}
\vspace{0.01cm}
...
INIS/IAEA concentra literatura e información nuclear especializada. Sirve para vigilancia técnica nuclear.

\sectiontitle{2. Qué datos se descargaron}
\begin{calloutbox}{Tipología de datos}
Registros de informacion nuclear y vigilancia técnica
\end{calloutbox}
\textbf{Datos descargados para CCHEN.} CSV de vigilancia INIS/IAEA con registros nucleares relevantes a CCHEN.
...
\begin{itemize}
\item \path{Data/Vigilancia/iaea_inis_monitor.csv}
\item \path{Data/Vigilancia/iaea_inis_state.json}
\end{itemize}

\sectiontitle{5. Estadística de descarga}
Registros obtenidos/evidencia: 110. Archivos locales generados o registrados: 2. Calidad registrada: 1.0. Última actualización: 2026-05-19. Estado de corrida: success.

\end{minipage}\hfill
\begin{minipage}[t]{0.48\textwidth}\raggedright
\sectiontitle{6. Para qué sirve en el observatorio}
\begin{itemize}
  \item \textbf{Uso principal:} Vigilancia especializada de INIS/IAEA para informacion nuclear relevante a CCHEN.
  \item \textbf{Potencial:} Vigilancia especializada de INIS/IAEA para informacion nuclear relevante a CCHEN.
\end{itemize}
...
\vspace{0.02cm}
{\scriptsize\color{mutedgray}Sitio: https://inis.iaea.org \quad | \quad Interfaz de datos: sin interfaz registrada}
