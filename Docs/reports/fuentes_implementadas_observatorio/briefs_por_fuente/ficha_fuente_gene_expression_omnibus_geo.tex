...
\hypersetup{colorlinks=true, linkcolor=cchenpurple, urlcolor=cchenpurple,
  pdftitle={Ficha de fuente de información - Gene Expression Omnibus (GEO)},
  pdfauthor={CCHEN 360}}
\urlstyle{same}
\pagestyle{fancy}
\fancyhf{}
...
\begin{center}
{\fontsize{16}{17.5}\selectfont\bfseries\color{cchenpurple}Gene Expression Omnibus (GEO)}\\[-1pt]
{\fontsize{9.1}{10.4}\selectfont\color{textgray}Ficha de fuente de información para datos relacionados con CCHEN}\\[-1pt]
{\fontsize{7.8}{9}\selectfont\color{mutedgray}Código: \texttt{geo} \quad | \quad Categoría: Life Sciences}
\end{center}
\vspace{0.01cm}
...
Repositorio de datos de expresión génica. Se documenta como evidencia derivada para flujos biomédicos.

\sectiontitle{2. Qué datos se descargaron}
\begin{calloutbox}{Tipología de datos}
Datos de expresion génica relacionados por flujos derivados
\end{calloutbox}
\textbf{Datos descargados para CCHEN.} No hay extractor directo GEO; la evidencia viene de PubMed/radiofarmacia como aproximacion temática.
...
\begin{itemize}
  ...
  \item \textbf{Potencial:} Aporta datos expresión génica para completar vistas del observatorio.
\end{itemize}
...
\vspace{0.02cm}
{\scriptsize\color{mutedgray}Sitio: https://www.ncbi.nlm.nih.gov/geo/ \quad | \quad Interfaz de datos: sin interfaz registrada}
