...
\hypersetup{colorlinks=true, linkcolor=cchenpurple, urlcolor=cchenpurple,
  pdftitle={Ficha de fuente de información - NIH},
  pdfauthor={CCHEN 360}}
\urlstyle{same}
\pagestyle{fancy}
\fancyhf{}
...
\begin{center}
{\fontsize{16}{17.5}\selectfont\bfseries\color{cchenpurple}NIH}\\[-1pt]
{\fontsize{9.1}{10.4}\selectfont\color{textgray}Ficha de fuente de información para datos relacionados con CCHEN}\\[-1pt]
{\fontsize{7.8}{9}\selectfont\color{mutedgray}Código: \texttt{nih} \quad | \quad Categoría: Life Sciences}
\end{center}
\vspace{0.01cm}
...
Ecosistema de información biomédica de NIH. En esta etapa se usa como referencia derivada, no como conexión directa propia.

\sectiontitle{2. Qué datos se descargaron}
\begin{calloutbox}{Tipología de datos}
Investigacion biomédica relacionada por flujos derivados
\end{calloutbox}
\textbf{Datos descargados para CCHEN.} No hay extractor directo NIH; la evidencia viene de PubMed/radiofarmacia como aproximacion temática.
...
\begin{itemize}
  ...
  \item \textbf{Potencial:} Aporta investigación biomédica para completar vistas del observatorio.
\end{itemize}
...
\vspace{0.02cm}
{\scriptsize\color{mutedgray}Sitio: https://www.nih.gov/ \quad | \quad Interfaz de datos: sin interfaz registrada}
