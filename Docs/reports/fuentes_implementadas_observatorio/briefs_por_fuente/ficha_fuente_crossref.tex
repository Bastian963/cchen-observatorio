...
\hypersetup{colorlinks=true, linkcolor=cchenpurple, urlcolor=cchenpurple,
  pdftitle={Ficha de fuente de información - Crossref},
  pdfauthor={CCHEN 360}}
\urlstyle{same}
\pagestyle{fancy}
\fancyhf{}
...
\begin{center}
{\fontsize{16}{17.5}\selectfont\bfseries\color{cchenpurple}Crossref}\\[-1pt]
{\fontsize{9.1}{10.4}\selectfont\color{textgray}Ficha de fuente de información para datos relacionados con CCHEN}\\[-1pt]
{\fontsize{7.8}{9}\selectfont\color{mutedgray}Código: \texttt{crossref} \quad | \quad Categoría: Científica}
\end{center}
\vspace{0.01cm}
...
Infraestructura internacional de DOI académicos. Entrega metadatos bibliográficos, referencias, revistas, financiadores y enlaces por DOI.

\sectiontitle{2. Qué datos se descargaron}
\begin{calloutbox}{Tipología de datos}
Metadatos DOI, referencias, abstracts y funding
\end{calloutbox}
\textbf{Datos descargados para CCHEN.} CSV enriquecido por DOI CCHEN con metadatos, referencias, abstracts y financiadores.
...
\begin{itemize}
\item \path{Data/Publications/cchen_crossref_enriched.csv}
\item \path{Data/Publications/crossref_state.json}
\end{itemize}

\sectiontitle{5. Estadística de descarga}
Registros obtenidos/evidencia: 1434. Archivos locales generados o registrados: 2. Calidad registrada: 1.0. Última actualización: 2026-05-11. Estado de corrida: seeded\_from\_resultados.

\end{minipage}\hfill
\begin{minipage}[t]{0.48\textwidth}\raggedright
\sectiontitle{6. Para qué sirve en el observatorio}
\begin{itemize}
  \item \textbf{Uso principal:} Enriquecer DOI CCHEN con metadatos bibliograficos, referencias, abstracts y funding.
  \item \textbf{Potencial:} Enriquecer DOI CCHEN con metadatos bibliograficos, referencias, abstracts y funding.
\end{itemize}
...
\end{calloutbox}
Estado catalogo: implementada en registro operativo. Ultima corrida: seeded\_from\_resultados; ultima actualizacion: 2026-05-11.
...
\vspace{0.02cm}
{\scriptsize\color{mutedgray}Sitio: https://www.crossref.org \quad | \quad Interfaz de datos: https://api.crossref.org/swagger-ui/index.html}
