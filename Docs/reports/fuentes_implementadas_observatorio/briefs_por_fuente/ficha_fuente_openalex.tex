...
\hypersetup{colorlinks=true, linkcolor=cchenpurple, urlcolor=cchenpurple,
  pdftitle={Ficha de fuente de información - OpenAlex},
  pdfauthor={CCHEN 360}}
\urlstyle{same}
\pagestyle{fancy}
\fancyhf{}
...
\begin{center}
{\fontsize{16}{17.5}\selectfont\bfseries\color{cchenpurple}OpenAlex}\\[-1pt]
{\fontsize{9.1}{10.4}\selectfont\color{textgray}Ficha de fuente de información para datos relacionados con CCHEN}\\[-1pt]
{\fontsize{7.8}{9}\selectfont\color{mutedgray}Código: \texttt{openalex} \quad | \quad Categoría: Científica}
\end{center}
\vspace{0.01cm}
...
{\Large\bfseries varios archivos: 949; 21348; 877; 8499}\par
...
Grafo académico abierto que conecta publicaciones, autores, instituciones, conceptos, citas, fuentes y financiadores.

\sectiontitle{2. Qué datos se descargaron}
\begin{calloutbox}{Tipología de datos}
Publicaciones, autores, conceptos, afiliaciones y citas
\end{calloutbox}
\textbf{Datos descargados para CCHEN.} CSVs de works, authorships, conceptos, grants y tablas bibliométricas CCHEN.
...
\begin{itemize}
\item \path{Data/Publications/cchen_openalex_works.csv}
\item \path{Data/Publications/openalex_state.json}
\item \path{Data/Publications/cchen_openalex_concepts.csv}
\item \path{Data/Publications/cchen_citation_graph.csv}
\end{itemize}

\sectiontitle{5. Estadística de descarga}
Registros obtenidos/evidencia: varios archivos: 949; 21348; 877; 8499. Archivos locales generados o registrados: 5. Calidad registrada: 1.0. Última actualización: 2026-05-11; 2026-03-21; 2026-03-29; 2026-03-22. Estado de corrida: seeded\_from\_resultados. Los valores múltiples corresponden a artefactos distintos; no deben sumarse como una sola tabla.

\end{minipage}\hfill
\begin{minipage}[t]{0.48\textwidth}\raggedright
\sectiontitle{6. Para qué sirve en el observatorio}
\begin{itemize}
  \item \textbf{Uso principal:} Base principal de publicaciones, autores, conceptos y relaciones bibliométricas CCHEN.
  \item \textbf{Potencial:} Base principal de publicaciones, autores, conceptos y relaciones bibliométricas CCHEN.
\end{itemize}
...
\end{calloutbox}
Estado catalogo: implementada en registro operativo. Ultima corrida: seeded\_from\_resultados; ultima actualizacion: 2026-05-11; 2026-03-21; 2026-03-29; 2026-03-22.
...
\vspace{0.02cm}
{\scriptsize\color{mutedgray}Sitio: https://openalex.org/ \quad | \quad Interfaz de datos: sin interfaz registrada}
