...
\hypersetup{colorlinks=true, linkcolor=cchenpurple, urlcolor=cchenpurple,
  pdftitle={Ficha de fuente de información - PubMed},
  pdfauthor={CCHEN 360}}
\urlstyle{same}
\pagestyle{fancy}
\fancyhf{}
...
\begin{center}
{\fontsize{16}{17.5}\selectfont\bfseries\color{cchenpurple}PubMed}\\[-1pt]
{\fontsize{9.1}{10.4}\selectfont\color{textgray}Ficha de fuente de información para datos relacionados con CCHEN}\\[-1pt]
{\fontsize{7.8}{9}\selectfont\color{mutedgray}Código: \texttt{pubmed} \quad | \quad Categoría: Científica}
\end{center}
\vspace{0.01cm}
...
Base bibliográfica biomédica de NCBI. Aporta literatura en salud, medicina nuclear, radiofarmacia y ciencias de la vida.

\sectiontitle{2. Qué datos se descargaron}
\begin{calloutbox}{Tipología de datos}
Publicaciones biomédicas, medicina nuclear y radiofarmacia
\end{calloutbox}
\textbf{Datos descargados para CCHEN.} CSV de publicaciones PubMed con señal CCHEN en DOI, autor, afiliacion o tema relevante.
...
Registros obtenidos/evidencia: 20. Archivos locales generados o registrados: 2. Calidad registrada: 1.0. Última actualización: 2026-05-11. Estado de corrida: seeded\_from\_resultados.

\end{minipage}\hfill
\begin{minipage}[t]{0.48\textwidth}\raggedright
\sectiontitle{6. Para qué sirve en el observatorio}
\begin{itemize}
  \item \textbf{Uso principal:} Capturar publicaciones biomédicas, medicina nuclear y radiofarmacia con señal CCHEN.
  \item \textbf{Potencial:} Capturar publicaciones biomédicas, medicina nuclear y radiofarmacia con señal CCHEN.
\end{itemize}
...
\vspace{0.02cm}
{\scriptsize\color{mutedgray}Sitio: https://pubmed.ncbi.nlm.nih.gov \quad | \quad Interfaz de datos: https://www.ncbi.nlm.nih.gov/home/develop/api/}
