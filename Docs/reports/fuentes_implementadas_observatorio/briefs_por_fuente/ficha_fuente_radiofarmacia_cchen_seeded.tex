...
\hypersetup{colorlinks=true, linkcolor=cchenpurple, urlcolor=cchenpurple,
  pdftitle={Ficha de fuente de información - PubChem},
  pdfauthor={CCHEN 360}}
\urlstyle{same}
\pagestyle{fancy}
\fancyhf{}
...
\begin{center}
{\fontsize{16}{17.5}\selectfont\bfseries\color{cchenpurple}PubChem}\\[-1pt]
{\fontsize{9.1}{10.4}\selectfont\color{textgray}Ficha de fuente de información para datos relacionados con CCHEN}\\[-1pt]
{\fontsize{7.8}{9}\selectfont\color{mutedgray}Código: \texttt{radiofarmacia\_cchen} \quad | \quad Categoría: Bio/Farma}
\end{center}
\vspace{0.01cm}
...
Paquete temático construido con semillas de radiofarmacia, compuestos, radionúclidos y literatura técnica abierta.

\sectiontitle{2. Qué datos se descargaron}
\begin{calloutbox}{Tipología de datos}
Radiofarmacos, radionuclidos, compuestos PubChem y literatura técnica
\end{calloutbox}
\textbf{Datos descargados para CCHEN.} CSVs de semillas, compuestos/radionuclidos, literatura, curaduria y revision operativa.

\sectiontitle{3. Cómo se filtra}
Probe relacionada con CCHEN por alias institucional; activar solo con resultados relevantes.
...
\item \path{Data/Gobernanza/radiofarmacia_cchen_literature.csv}
\item \path{Data/Gobernanza/radiofarmacia_cchen_status.csv}
\end{itemize}

\sectiontitle{5. Estadística de descarga}
Registros obtenidos/evidencia: 875. Archivos locales generados o registrados: 12. Calidad registrada: 1.0. Última actualización: 2026-05-19. Estado de corrida: success.
...
\begin{itemize}
  ...
  \item \textbf{Potencial:} Consolidar semillas de radiofarmacos, radionuclidos, PubChem y literatura abierta relevante.
\end{itemize}
...
\vspace{0.02cm}
{\scriptsize\color{mutedgray}Sitio: https://pubchem.ncbi.nlm.nih.gov \quad | \quad Interfaz de datos: https://pubchem.ncbi.nlm.nih.gov/docs/pug-rest\#section=The-URL-Path}
