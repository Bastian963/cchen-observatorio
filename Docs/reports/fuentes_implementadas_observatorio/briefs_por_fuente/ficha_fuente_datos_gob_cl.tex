...
\hypersetup{colorlinks=true, linkcolor=cchenpurple, urlcolor=cchenpurple,
  pdftitle={Ficha de fuente de información - Datos.gob.cl},
  pdfauthor={CCHEN 360}}
\urlstyle{same}
\pagestyle{fancy}
\fancyhf{}
...
\begin{center}
{\fontsize{16}{17.5}\selectfont\bfseries\color{cchenpurple}Datos.gob.cl}\\[-1pt]
{\fontsize{9.1}{10.4}\selectfont\color{textgray}Ficha de fuente de información para datos relacionados con CCHEN}\\[-1pt]
{\fontsize{7.8}{9}\selectfont\color{mutedgray}Código: \texttt{datos\_gob\_cl} \quad | \quad Categoría: Datos Abiertos}
\end{center}
\vspace{0.01cm}
...
{\Large\bfseries varios archivos: 84; 126}\par
...
{\normalsize\bfseries Implementada registro operativo/local}\par
...
Portal chileno de datos abiertos. Aporta contexto institucional y registros públicos vinculables a CCHEN.

\sectiontitle{2. Qué datos se descargaron}
\begin{calloutbox}{Tipología de datos}
Convenios, acuerdos e informacion institucional publica
\end{calloutbox}
\textbf{Datos descargados para CCHEN.} CSVs institucionales de convenios y acuerdos públicos asociados a CCHEN.
...
\begin{itemize}
\item \path{Data/Institutional/clean_Convenios_suscritos_por_la_Com.csv}
\item \path{Data/Institutional/clean_Acuerdos_e_instrumentos_intern.csv}
\end{itemize}

\sectiontitle{5. Estadística de descarga}
Registros obtenidos/evidencia: varios archivos: 84; 126. Archivos locales generados o registrados: 2. Calidad registrada: 1.0. Última actualización: 2026-03-21. Estado de corrida: seeded\_from\_resultados. Los valores múltiples corresponden a artefactos distintos; no deben sumarse como una sola tabla.

\end{minipage}\hfill
\begin{minipage}[t]{0.48\textwidth}\raggedright
\sectiontitle{6. Para qué sirve en el observatorio}
\begin{itemize}
  \item \textbf{Uso principal:} Datos publicos nacionales vinculados a convenios, acuerdos e informacion institucional CCHEN.
  \item \textbf{Potencial:} Datos publicos nacionales vinculados a convenios, acuerdos e informacion institucional CCHEN.
\end{itemize}
...
\end{calloutbox}
Estado catalogo: implementada en registro operativo. Ultima corrida: seeded\_from\_resultados; ultima actualizacion: 2026-03-21.
...
\vspace{0.02cm}
{\scriptsize\color{mutedgray}Sitio: https://datos.gob.cl \quad | \quad Interfaz de datos: sin interfaz registrada}
