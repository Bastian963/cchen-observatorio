...
\hypersetup{colorlinks=true, linkcolor=cchenpurple, urlcolor=cchenpurple,
  pdftitle={Ficha de fuente de información - ORCID},
  pdfauthor={CCHEN 360}}
\urlstyle{same}
\pagestyle{fancy}
\fancyhf{}
...
\begin{center}
{\fontsize{16}{17.5}\selectfont\bfseries\color{cchenpurple}ORCID}\\[-1pt]
{\fontsize{9.1}{10.4}\selectfont\color{textgray}Ficha de fuente de información para datos relacionados con CCHEN}\\[-1pt]
{\fontsize{7.8}{9}\selectfont\color{mutedgray}Código: \texttt{orcid} \quad | \quad Categoría: Científica}
\end{center}
\vspace{0.01cm}
...
Registro global de identificadores persistentes de investigadores. Permite vincular personas, afiliaciones y obras declaradas.

\sectiontitle{2. Qué datos se descargaron}
\begin{calloutbox}{Tipología de datos}
Perfiles de investigadores, afiliaciones e identificadores
\end{calloutbox}
\textbf{Datos descargados para CCHEN.} CSV de perfiles ORCID de investigadores CCHEN y metadatos asociados.
...
\begin{itemize}
\item \path{Data/Researchers/cchen_researchers_orcid.csv}
\item \path{Data/Researchers/orcid_state.json}
\end{itemize}

\sectiontitle{5. Estadística de descarga}
Registros obtenidos/evidencia: 65. Archivos locales generados o registrados: 2. Calidad registrada: 1.0. Última actualización: 2026-05-11. Estado de corrida: seeded\_from\_resultados.

\end{minipage}\hfill
\begin{minipage}[t]{0.48\textwidth}\raggedright
\sectiontitle{6. Para qué sirve en el observatorio}
\begin{itemize}
  \item \textbf{Uso principal:} Mantener perfiles de investigadores CCHEN, afiliaciones, identificadores y obras declaradas.
  \item \textbf{Potencial:} Mantener perfiles de investigadores CCHEN, afiliaciones, identificadores y obras declaradas.
\end{itemize}
...
\vspace{0.02cm}
{\scriptsize\color{mutedgray}Sitio: https://orcid.org \quad | \quad Interfaz de datos: https://info.orcid.org/documentation/features/public-api/}
