...
\begin{itemize}
  \item \textbf{Publicaciones:} \texttt{Data/Publications/}; \textbf{outputs:} \texttt{Data/ResearchOutputs/}.
  \item \textbf{Gobernanza, radiofarmacia y curaduría:} \texttt{Data/Gobernanza/}.
  \item \textbf{Vigilancia:} \texttt{Data/Vigilancia/}; \textbf{patentes:} \texttt{Data/Patents/}.
\end{itemize}
