# Brief de fuente implementada: Sequence Read Archive

**Source key:** `sequence_read_archive`  
...
![Resumen de fuente](../assets/sequence_read_archive_resumen.png)

## Ficha rapida para Fernanda

- **Tipo de datos descargados:** No hay extractor directo SRA; la evidencia viene de PubMed/radiofarmacia como aproximacion temática.
- **Tipologia de datos:** Datos genómicos relacionados por flujos derivados
...
Implementada como fuente derivada/semilla CCHEN-only; Aporta datos genómicos para completar vistas del observatorio; mantener como evidencia tecnica, no como conexion directa a la fuente original.
...
Aporta datos genómicos para completar vistas del observatorio.
...
- Sitio: https://www.ncbi.nlm.nih.gov/sra
