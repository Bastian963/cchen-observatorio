# Brief de fuente implementada: GenBank
...
![Resumen de fuente](../assets/genbank_resumen.png)

## Ficha rapida para Fernanda

- **Tipo de datos descargados:** No hay extractor directo GenBank; la evidencia viene de PubMed/radiofarmacia como aproximacion temática.
- **Tipologia de datos:** Secuencias genéticas relacionadas por flujos biomédicos derivados
...
Implementada como fuente derivada/semilla CCHEN-only; Aporta secuencias genéticas para completar vistas del observatorio; mantener como evidencia tecnica, no como conexion directa a la fuente original.
...
Aporta secuencias genéticas para completar vistas del observatorio.
...
- Sitio: https://www.ncbi.nlm.nih.gov/genbank/
