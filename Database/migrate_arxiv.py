"""
migrate_arxiv.py — Observatorio CCHEN 360°
==========================================
Migra cchen_arxiv_works.csv a la tabla arxiv_works en Supabase.
...
USO:
    ...
    PYTHONUNBUFFERED=1 python3 -u Database/migrate_arxiv.py
"""
...
CSV_PATH = ROOT / "Data" / "Publications" / "cchen_arxiv_works.csv"
...
def migrate_arxiv():
    ...
    cols = [
        "arxiv_id", "doi", "title", "authors", "categories",
        "year", "pub_date", "updated_date", "abstract",
    ...
    for i in range(batches):
        ...
        try:
            supabase.table("arxiv_works").upsert(
                chunk, on_conflict="arxiv_id"
            ).execute()
    ...
    return {"table": "arxiv_works", "rows": total, "batches": batches, "errors": errors}


if __name__ == "__main__":
    result = migrate_arxiv()
