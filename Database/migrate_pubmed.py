"""
migrate_pubmed.py — Observatorio CCHEN 360°
============================================
Migra cchen_pubmed_works.csv a la tabla pubmed_works en Supabase.
...
USO:
    ...
    PYTHONUNBUFFERED=1 python3 -u Database/migrate_pubmed.py
"""
...
CSV_PATH = ROOT / "Data" / "Publications" / "cchen_pubmed_works.csv"
...
def migrate_pubmed():
    ...
    cols = [
        "pmid", "doi", "pmcid", "title", "authors",
        "journal", "year", "pub_date", "abstract",
        "keywords", "is_open_access", "affiliation_raw",
    ...
    for i in range(batches):
        ...
        try:
            supabase.table("pubmed_works").upsert(
                chunk, on_conflict="pmid"
            ).execute()
    ...
    return {"table": "pubmed_works", "rows": total, "batches": batches, "errors": errors}


if __name__ == "__main__":
    result = migrate_pubmed()
