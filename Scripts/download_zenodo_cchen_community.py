"""
Script para descargar todos los recursos públicos de la comunidad CCHEN en Zenodo.
Descarga archivos y metadatos de todos los depósitos asociados a la comunidad.
...
2. Ejecuta el script: python download_zenodo_cchen_community.py
"""
...
COMMUNITY = "cchen"  # Cambia por el slug de la comunidad si es distinto
TOKEN = os.getenv("ZENODO_TOKEN")

HEADERS = {"Authorization": f"Bearer {TOKEN}"} if TOKEN else {}

# 1. Listar todos los depósitos públicos de la comunidad
...
def download_files_and_metadata(deposits, output_dir="zenodo_cchen_downloads"):
...
if __name__ == "__main__":
    ...
    deposits = list_community_deposits()
    print(f"Se encontraron {len(deposits)} depósitos.")
    download_files_and_metadata(deposits)
