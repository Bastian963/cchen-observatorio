...
rg -q '/etc/nginx/.htpasswd' "$TMP_CONFIG"
rg -q 'OBSERVATORIO_DASHBOARD_URL: https://obs-int.cchen.cl' "$TMP_CONFIG"
rg -q 'CKAN_SITE_URL: https://datos-int.cchen.cl' "$TMP_CONFIG"
rg -q 'dspace__P__server__P__url: https://repo-int.cchen.cl/server' "$TMP_CONFIG"
